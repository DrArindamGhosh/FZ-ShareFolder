...
file_path = 'Portland\Portland_Traj_Mat_Test.xlsx'
...
file_path = 'Portland\PortlandVelocityTest.xlsx'
...
def calculateDriveTorque(longThrust, rearLHSWheelVelocity, rearRHSWheelVelocity):
    ...
    # MDriveRL = saturation(MDriveRL, 0, 800)
    # MDriveRR = saturation(MDriveRR, 0, 800)
...
def calculateBrakeTorque(longThrust, rearLHSWheelVelocity, rearRHSWheelVelocity):
    ...
    # MBrakeFL = saturation(MBrakeFL, 0, 800)
    # MBrakeFR = saturation(MBrakeFR, 0, 800)
    # MBrakeRL = saturation(MBrakeRL, 0, 800)
    # MBrakeRR = saturation(MBrakeRR, 0, 800)
