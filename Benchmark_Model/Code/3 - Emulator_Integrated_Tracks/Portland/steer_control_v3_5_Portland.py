...
def AngularOffset(ref_orientation, refDistance, orientation, e_phi_gain):
    # Computes the angular offset from the ideal orientation by comparing the current orientation with the reference orientation (trajectory orientation)
...
def calculate_steering_control(Vx, Vy, yawAngle, x, y):
    ...
    e_phi, refLine_orientation = AngularOffset(ref_orientation, ref_distance, yawAngle, e_phi_gain)
