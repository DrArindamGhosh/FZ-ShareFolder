...
def refStateNow(trajectory_matrix, Vx, Vy, orientation, timestep):
    ...
    return refDistance, refOrientation, nLap
...
def calculateTorqueControl(trajectory_matrix, vCarData, Vx, Vy, yawAngle, x, y, WheelVelocityRL, WheelVelocityRR, SlipFL, SlipFR, SlipRL, SlipRR, steering_input):
    ...
    ref_distance, ref_orientation, nLap = refStateNow(trajectory_matrix, Vx, Vy, yawAngle, timestep)
