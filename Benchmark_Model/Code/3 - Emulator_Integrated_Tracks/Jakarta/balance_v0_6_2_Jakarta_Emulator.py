...
def receive_all(client_socket, num_bytes):
    data = b''
...
def main():
    ...
    for _ in range(iterations):
        ...
        try:
            ...
            data = receive_all(client_socket, expected_length)
            ...
            if received_length != expected_length:
                print(f"Data loss detected at iteration {_+1}. Breaking the loop.")
                break
            ...
            print(f"x = {x}, y = {y}, Vx = {Vx}, Vy = {Vy}, yawAngle = {yawAngle}")

        except socket.timeout:
            print(f"Socket timeout at iteration {_+1}. Breaking the loop.")
            break
        except socket.error as e:
            print(f"Socket error at iteration {_+1}: {e}. Breaking the loop.")
            break
        # finally:
        client_socket.close()
