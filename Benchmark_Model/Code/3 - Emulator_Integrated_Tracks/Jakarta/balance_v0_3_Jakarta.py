...
def main():
    ...
    for _ in range(iterations):
        ...
        # if yawAngles and yawAngles[-1] < -2:
        #     if yawAngle > -1: 
        #         yawAngle = yawAngle - 2*np.pi
        ...
        if MDriveRL > 3000 or MDriveRR > 3000 or MBrakeFL > 3000 or MBrakeFR > 3000 or MBrakeRL > 3000 or MBrakeRR > 3000:
            print(f"Breaking loop at iteration {_+1} due to Torque values > 3000")
            break
