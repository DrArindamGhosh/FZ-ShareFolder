from steer_control_v3_4_London import calculate_steering_control
from speed_control_v2_3_London import calculateTorqueControl
...
def main():
    ...
    for _ in range(iterations):
        ...
        steering_input, e_phi, saturated_e_l, levercoordsplot, idealcoordsplot, error_values, refLine_orientation, refDistance = calculate_steering_control(Vx, Vy, yawAngle, x, y, timeStep)
        if abs(e_phi) > 5:
