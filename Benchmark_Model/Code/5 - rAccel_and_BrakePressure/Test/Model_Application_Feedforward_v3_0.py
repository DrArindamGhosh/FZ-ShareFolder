...
from steer_control_v3_0_Feedforward import calculate_steering_FF
from pedal_control_v1_8 import calculatePedalPercent
from pedal_control_v3_0_Feedforward import calculatePedalFF
                    ...
                    while nLap < configured_laps:
                        ...
                        if ff_enabled:
                            if StopFlag == True:
                                ...
                                steering_inputs.append(steering_input)
                                steering_input, e_phi, saturated_e_l, refLine_orientation, refDistance, steer_integral, steer_prev_error, newSim, s_Kp, s_Ki, s_Kd, target_steer, nLap = calculate_steering_FF(
