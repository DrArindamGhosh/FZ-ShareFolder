...
def compute_feedforward(ref_distance, vProfiledf):
    ...
    throttle_interpolator = interp1d(vProfiledf['sDistance_Pedal'], vProfiledf['rAccel'], kind='linear', fill_value="extrapolate")
    brake_interpolator = interp1d(vProfiledf['sDistance_Pedal'], vProfiledf['pBrakeFIA'], kind='linear', fill_value="extrapolate")
