...
# time_save_dir = os.path.join(save_dir, time_str)
...
def plotTraj(base_name, tracks_df, sim_x, sim_y, lever_coordinates, ideal_coordinates, e_l_values, current_time):
    ...
    plt.legend()
    folder_name = f"{time_str}_{base_name}"
    time_save_dir = os.path.join(save_dir, folder_name)
    os.makedirs(time_save_dir, exist_ok=True)
    # plt.savefig(os.path.join(output_dir, f'{current_time}_{base_name}_A_Vehicle_Trajectory.png'))
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_A_Vehicle_Trajectory.png'))
...
def plot_e_phi_Values(base_name, e_phi_values, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_E_Angular_Offset.png'))
...
def plot_e_l_Values(base_name, saturated_e_l_values, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_F_Lateral_Offset.png'))
...
def plot_balance_Values(base_name, steering_input, line_orientation, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_B_Steering_Input_and_Target.png'))
...
def plot_Angles(base_name, yaw_angle, line_orientation, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_C_Car_and_Trajectory_Orientation.png'))
...
def plot_Torque(base_name, MDriveRL, MDriveRR, MBrakeFL, MBrakeFR, MBrakeRL, MBrakeRR, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_L_Car_Torques.png'))
...
def plot_TargetValues(base_name, targetVelocityArray, longAccelerationArray, bPressure, current_Velocity, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_G_Target_Velocity_Values.png'))
...
def plot_PedalValues(base_name, accPedal, bPressure, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_H_Pedal_Values.png'))
...
def plot_nMGU_Values(base_name, nMGU, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_M_nMGU.png'))
...
def plot_Throttle_PID_Values(base_name, t_P, t_I, t_D, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_I_Throttle_PID_Values.png'))
...
def plot_Brake_PID_Values(base_name, b_P, b_I, b_D, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_J_Brake_PID_Values.png'))
...
def plot_vCar_error_Values(base_name, vCar_error, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_K_vCar_error.png'))
...
def plot_refDistances(base_name, refDistances, current_time):
    ...
    if not os.path.exists(time_save_dir):
        os.makedirs(time_save_dir, exist_ok=True)
    plt.savefig(os.path.join(time_save_dir, f'{current_time}_{base_name}_D_refDistances.png'))
