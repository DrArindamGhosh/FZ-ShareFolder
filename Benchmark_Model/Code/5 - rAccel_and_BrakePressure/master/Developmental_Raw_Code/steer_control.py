...
def LeverDistances(longitudinal_velocity):
    ...
    # L[0] = 0
    # L[1] = longitudinal_velocity * 0.2
    # L[2] = longitudinal_velocity * 0.4
    # L[3] = longitudinal_velocity * 0.6
    # L[4] = longitudinal_velocity * 0.8
    # L[5] = longitudinal_velocity * 1
    # L[6] = longitudinal_velocity * 1.4
    # L[7] = longitudinal_velocity * 2.0
