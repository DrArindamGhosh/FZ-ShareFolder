...
import os
import logging
from steer_control_v2_2 import calculate_steering_control
...
class ConsoleApp:
    ...
    def create_torque_control_parameters(self):
        ...
        self.brake_Kp_entry.insert(0, "1.0")
        ...
        self.brake_Ki_entry.insert(0, "0.01")
            ...
            while not self.abort_flag.is_set():
                ...
                try:
                    while nLap < configured_laps:
                        ...
                        if (max_ref_distance - 600) - refDistance < 0.5:
                            print("Lap Completed")
                            nLap += 1
