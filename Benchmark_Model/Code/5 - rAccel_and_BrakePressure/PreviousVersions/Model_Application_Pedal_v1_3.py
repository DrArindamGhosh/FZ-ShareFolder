...
# NEXT ITERATION REQUIRES CONTR0L OF THROTTLE OVER TARGET VELOCITY
...
from pedal_control_v1_3 import calculatePedalPercent
...
class ConsoleApp:
    ...
    def create_torque_control_parameters(self):
        ...
        tk.Label(self.torque_control_frame, text="Future TD:").grid(row=9, column=0, sticky="w")
        self.futureTD = tk.Entry(self.torque_control_frame, width=5)
        self.futureTD.grid(row=9, column=1, padx=5)
            ...
            while not self.abort_flag.is_set():
                ...
                try:
                    while nLap < configured_laps:
                        ...
                        steering_input, e_phi, saturated_e_l, levercoordsplot, idealcoordsplot, error_values, refLine_orientation, refDistance, newSim, nLap, total_e_l = calculate_steering_control(
                        ...
                        max_engine_brake_torque, differential_gain_1, driving_differential_gain, overrun_differential_gain, front_wheel_coefficient, rear_wheel_coefficient, max_drive_torque, max_brake_torque, futureTD, Dil_Mode_enabled)
