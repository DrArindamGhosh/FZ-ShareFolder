...
def calculateFutureVelocity(Vx, Vy, vCarData, trajectory_matrix, refDistance, nLap, futureTD):
...
def calculatePedalPercent(tracks_df, vProfiledf, Vx, Vy, timestep, ref_distance, nLap, throttle_Kp, throttle_Ki, throttle_Kd, throttle_integral, throttle_prev_error,
    ...
    futureVelocity = calculateFutureVelocity(Vx, Vy, vCarData, trajectory_matrix, ref_distance, nLap, futureTD)
