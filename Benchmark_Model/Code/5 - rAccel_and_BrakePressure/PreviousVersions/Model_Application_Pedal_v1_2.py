# PID Controllers on just pedals
# Multi-Lap follow through track loop dataframe manipulation
# MULTI LAP WORKS DEV MODE ONLY
# NEXT ITERATION REQUIRES CONTRL OF THROTTLE OVER TARGET VELOCITY
...
from pedal_control_v1_0 import calculatePedalPercent
from model_traj_test_v6 import plotTraj, plot_e_phi_Values, plot_e_l_Values, plot_balance_Values, plot_Angles, plot_Torque, plot_TargetValues, plot_AccPedalValues, plot_nMGU_Values, plot_bPressure_array_Values, plot_Throttle_PID_Values, plot_Brake_PID_Values, plot_vCar_error_Values, plot_refDistances
import numpy as np
...
def generate_driving_line_Dev(tracks_df, x, y, yawAngle):
    ...
    return tracks_df, max_sDistance_lap1, max_sDistance_lap2
                ...
                try:
                    while nLap < configured_laps:
                        ...
                        if i == 1 or i % SCR == 0:
                            ...
                            try:
                                ...
                                if received_length == expected_length:
                                    ...
                                    # (x, y, z, Vx, Vy, Vz, yawAngle, SlipFL, SlipFR, SlipRL, SlipRR, WheelVelocityFL, WheelVelocityFR, WheelVelocityRL, WheelVelocityRR, newSimTime) = float_data
                                    # nMGU = 0
                            ...
                            if i == 1:
                                ...
                                if Dil_Mode_enabled == False:
                                    tracks_df, max_sDistance_Lap1, max_sDistance_Lap2 = generate_driving_line_Dev(tracks_df, x, y, yawAngle)
                        ...
                        steering_input, e_phi, saturated_e_l, levercoordsplot, idealcoordsplot, error_values, refLine_orientation, refDistance, newSim, nLap = calculate_steering_control(
                            tracks_df, Vx, Vy, yawAngle, x, y, e_phi_gain, timeStep, nLap, newSim, e_l_gains, e_l_limits, total_e_l_limits, steer_limits, Dil_Mode_enabled, max_sDistance_Lap1, max_sDistance_Lap2)
