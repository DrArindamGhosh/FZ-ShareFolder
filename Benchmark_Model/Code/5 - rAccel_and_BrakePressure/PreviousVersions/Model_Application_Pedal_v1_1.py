...
import os
import logging
from steer_control_v16_1 import calculate_steering_control
from PreviousVersions.pedal_control_v1_1 import calculatePedalPercent
from model_traj_test_v6 import plotTraj, plot_e_phi_Values, plot_e_l_Values, plot_balance_Values, plot_Angles, plot_Torque, plot_TargetValues, plot_AccPedalValues, plot_nMGU_Values, plot_bPressure_array_Values, plot_Throttle_PID_Values, plot_Brake_PID_Values, plot_vCar_error_Values
import numpy as np
...
class ConsoleApp:
    ...
    def create_parameter_buttons(self):
        ...
        self.num_Velocity_dropdown = tk.OptionMenu(self.param_frame, self.num_Velocity_var, *["80", "85", "90", "92", "94", "96", "98", "100"])
    ...
    def create_torque_control_parameters(self):
        ...
        tk.Label(self.torque_control_frame, text="Zero Pedal Distance:").grid(row=9, column=0, sticky="w")
        self.zero_pedal_distance_entry = tk.Entry(self.torque_control_frame, width=5)
        self.zero_pedal_distance_entry.grid(row=9, column=1, padx=5)
        self.zero_pedal_distance_entry.insert(0, "0.1")
    ...
    def run_backend_script(self):
        try:
            ...
            zero_pedal_distance = float(self.zero_pedal_distance_entry.get())
                ...
                try:
                    while nLap < configured_laps:
                        ...
                        steering_input, e_phi, saturated_e_l, levercoordsplot, idealcoordsplot, error_values, refLine_orientation, refDistance, newSim = calculate_steering_control(
                            tracks_df, Vx, Vy, yawAngle, x, y, e_phi_gain, timeStep, nLap, newSim, e_l_gains, e_l_limits, total_e_l_limits, steer_limits, Dil_Mode_enabled)
                        if invert_steering:
                        ...
                        max_engine_brake_torque, differential_gain_1, driving_differential_gain, overrun_differential_gain, front_wheel_coefficient, rear_wheel_coefficient, max_drive_torque, max_brake_torque, max_long_slip, slip_constant, zero_pedal_distance, Dil_Mode_enabled)
            ...
            plot_and_store(self.figures, plot_AccPedalValues, base_name, acc_array, current_time)
            plot_and_store(self.figures, plot_bPressure_array_Values, base_name, bPressure_array, current_time)
