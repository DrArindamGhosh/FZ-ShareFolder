...
interpolator = RegularGridInterpolator((MpedalMap_nMGU_Y, MpedalMap_rAccel_X), MPedalMap_Torque_Z)

# Example: Get torque for a specific (rAccel, nMGU) input
rAccel_input = 50  # Example rAccel value
nMGU_input = 0   # Example nMGU value
torque_output = interpolator((nMGU_input, rAccel_input))

print(f"Interpolated Torque at rAccel={rAccel_input}, nMGU={nMGU_input}: {torque_output}")
