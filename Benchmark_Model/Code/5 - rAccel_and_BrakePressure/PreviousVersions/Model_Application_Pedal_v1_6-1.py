...
class ConsoleApp:
    ...
    def create_live_data_frame(self):
        ...
        self.lap_times_canvas = tk.Canvas(lap_times_container, height=80, width=180, bg="white", highlightthickness=1, highlightbackground="#ccc")
        ...
        tk.Label(self.live_data_frame, textvariable=self.lap_completion_label_var, font=("Arial", 12)).grid(row=4, column=0, sticky="w")
