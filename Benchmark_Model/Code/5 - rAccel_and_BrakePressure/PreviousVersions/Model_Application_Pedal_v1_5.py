...
class ConsoleApp:
    ...
    def create_control_buttons(self):
        ...
        self.start_server_button = tk.Button(button_row, text="Start Server & Listen for Incoming Connections", bg="light yellow", command=self.start_server)
        ...
        self.abort_button = tk.Button(button_row, text="ABORT", bg="orange", command=self.abort_simulation, state="disabled")
        ...
        self.abort_button.pack(side="left", padx=5, pady=5)
    ...
    def create_force_input_buttons(self):
        ...
        tk.Label(self.force_input_frame, text="Accelerator Pedal (%):").grid(row=2, column=0, sticky="w")
        ...
        tk.Label(self.force_input_frame, text="Brake Pressure (bar):").grid(row=2, column=2, sticky="w")
    ...
    def create_pedal_control_parameters(self):
        ...
        ToolTip(self.futureTD, "Target distance used for feedforward throttle prediction")
    ...
    def create_torque_control_parameters(self):
        ...
        ToolTip(self.max_drive_torque_entry, "Maximum torque the engine is allowed to deliver")
        ToolTip(self.max_brake_torque_entry, "Maximum torque the brakes are allowed to apply")
            ...
            while not self.abort_flag.is_set():
                ...
                try:
                    while nLap < configured_laps:
                        ...
                        max_engine_brake_torque, differential_gain_1, driving_differential_gain, overrun_differential_gain, max_drive_torque, max_brake_torque, futureTD, Dil_Mode_enabled)
