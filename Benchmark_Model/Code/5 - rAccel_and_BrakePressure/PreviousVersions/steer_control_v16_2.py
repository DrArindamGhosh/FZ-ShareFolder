...
def refStateNow(trajectory_matrix, Vx, Vy, orientation, timestep, newSim, nLap, max_sDistance_Lap1, max_sDistance_Lap2, LapCompleted):
    global sdistance
    ...
    if nLap > 0:
        max_sdistance = max_sDistance_Lap2
...
def calculate_steering_control(tracks_df, Vx, Vy, yawAngle, x, y, e_phi_gain, timestep, nLap, newSim, 
                               e_l_gains, e_l_limits, total_e_l_limits, steer_limits, Dil_Mode, max_sDistance_Lap1, max_sDistance_Lap2, clockwise):
    ...
    # Reference State Now
    LapComplete = False
    ref_distance, newSim, nLap, LapComplete, phi = refStateNow(trajectory_matrix, Vx, Vy, yawAngle, timestep, newSim, nLap, max_sDistance_Lap1, max_sDistance_Lap2, LapComplete)
