...
def LateralOffset(r, l, orientation, gains, lower_limits, upper_limits, lower_total_e_l_limits, upper_total_e_l_limits):
    ...
    return e_l, saturated_e_l, saturated_total_e_l, error_values_gains_array, abort_e_l
...
def calculate_steering_control(tracks_df, Vx, Vy, yawAngle, x, y, e_phi_gain, timestep, nLap, newSim, 
    ...
    # Lateral Offset
    e_l, saturated_e_l, total_saturated_e_l, error_values_gains_array, abort_e_l = LateralOffset(ideal_path_points, lever_absolute_coordinates, yawAngle, 
    ...
    return steering_control_input, e_phi, saturated_e_l, lever_coords_plot, ideal_coordinates_plot, e_l, refLine_orientation, ref_distance, newSim, nLap, abort_e_l
