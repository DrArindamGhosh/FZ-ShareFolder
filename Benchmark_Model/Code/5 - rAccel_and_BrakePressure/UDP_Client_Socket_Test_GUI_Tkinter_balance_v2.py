...
def udp_client():
    ...
    try:
        ...
        while True:
            ...
            # Motor Speed
            nMGU = balance.ReadChannelScalar(carHandle, "Engine", "", "Engine Omega")
            ...
            print("Sending Data")
            # time.sleep(0.1)
            data_to_send = struct.pack('fffffffffffffffff', x, y, z, Vx, Vy, Vz, yawAngle, frontLHSWheelSlipRatio, frontRHSWheelSlipRatio, rearLHSWheelSlipRatio, 
                                       rearRHSWheelSlipRatio, frontLHSWheelVelocity, frontRHSWheelVelocity, rearLHSWheelVelocity, rearRHSWheelVelocity, nMGU, simTime)
