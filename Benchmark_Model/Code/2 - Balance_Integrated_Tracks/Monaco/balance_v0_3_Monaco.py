...
from speed_control_v2_3_Monaco import calculateTorqueControl
...
# from model_traj_test import plot_corners
...
def main():
    ...
    for _ in range(iterations):
        ...
        ###########################################################################################################################################################
        # Speed Control
        MDriveRL, MDriveRR, MBrakeFL, MBrakeFR, MBrakeRL, MBrakeRR, targetVelocity, longAcceleration, slipThrust, oldLongThrust, tVC = calculateTorqueControl(Vx, 
                                                                                                                                                            Vy, 
                                                                                                                                                            yawAngle, 
                                                                                                                                                            x, 
                                                                                                                                                            y, 
