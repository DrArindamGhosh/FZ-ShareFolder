...
def refStateNow(trajectory_matrix, Vx, Vy, orientation, timestep):
    ...
    return refDistance, refOrientation, refDistancekm
...
def calculate_steering_control(Vx, Vy, yawAngle, x, y):
    ...
    return steering_control_input, e_phi, saturated_e_l, lever_coords_plot, ideal_coordinates_plot, e_l, refLine_orientation, refDistances
