...
gearRatioFront = 8.47 
maxEngineBrakeTorque = 1.1
diffTorqueTransferGain1 = 0.2                 # To be tweaked
diffTorqueTransferGain2 = 0.2
...
def calculateTargetAcceleration(targetVelocity, Vx, Vy, shortDistance, scalingFactor):
...
def antiSlip(longThrust, LRslip, RRslip):
    ...
    print("Antislip: ", antiLockLR)
    longThrust = longThrust * antiLockLR * antiLockRR     
...
def calculateTorqueControl(Vx, Vy, yawAngle, x, y, WheelVelocityRL, WheelVelocityRR, SlipFL, SlipFR, SlipRL, SlipRR, steering_input):
    ...
    longAcceleration = calculateTargetAcceleration(targetVelocity, Vx, Vy, shortDistance, scalingFactor)
