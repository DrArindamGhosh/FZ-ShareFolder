...
from speed_control_v2_2 import calculateTorqueControl
...
def main():
    ...
    for _ in range(iterations):
        ...
        ###########################################################################################################################################################
        # Speed Control
        MDriveRL, MDriveRR, MBrakeFL, MBrakeFR, MBrakeRL, MBrakeRR, targetVelocityArray, longAccelerationArray = calculateTorqueControl(Vx, 
                                                                                                                                        Vy, 
                                                                                                                                        yawAngle, 
                                                                                                                                        x, 
                                                                                                                                        y, 
