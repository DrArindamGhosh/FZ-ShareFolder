...
def plot_balance_Values(x, y, Vx, Vy, steering_input):
    ...
    plt.title('X, Y, Velocities and Steering Input over Iterations')
    plt.xlabel('Iteration')
...
# def plot_corners(refLine_orientation, refDistances, targetVelocityArray):
    
#     plt.figure(figsize=(15, 10))
#     plt.plot(refLine_orientation, label='Orientation of Ref Line (Radians)')
#     plt.plot(refDistances, label='Distance along Reference Line (m)')
#     plt.plot(targetVelocityArray, label='Target Velocity (mps)')
    

#     plt.title('Reference Line Orientation and Distance over Iterations')
#     plt.xlabel('Iteration')
#     plt.ylabel('Yaw Angle')
#     plt.legend()
#     plt.grid(True)    
